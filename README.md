...
.read:hover{
  box-shadow: 0 0 5px aqua,
  0 0 25px aqua, 0 0 50px,
  0 0 100px aqua, 200px aqua;
}
...
.contact-form form .send:hover{
    box-shadow: 0 0 5px aqua,
    0 0 25px aqua, 0 0 50px aqua,
    0 0 100px aqua, 0 0 20px aqua;
}
.last-text p{
    width: 100%;
    text-align: center;
